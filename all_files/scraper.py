...
def main():
    ...
    for i in topic_links:
        ...
        new_link = '{0}{1}'.format("https://rug.nl/education/faq/", href[0])
    ...
    for i in first_loop_links:
        ...
        soup_end = BeautifulSoup(response_loop.content, "html.parser")

        # correct_li = soup_end.find_all('li', class_='rug-list--accordion__item')
        ...
        if len(option_choice) > 0:
            ...
            filename = 'aiml_file4/{0}.aiml'.format(topic_cleaner)
        else:
