# Filename: scraper_general.py
# Date: 19-06-2020
# This program will scrape all questions and answers from the RUG FAQ from all topics. It then transforms them to AIML categories.
# The output consists of .aiml files, they are named according to the topics structured as in the RUG  FAQ. 
# To call the script: $ python3 scraper_general.py
# packages used: selenium, bs4, re, pandas, requests, sys, os
# Author: Franka Korpel (html cleaning is done by Stan Snijders)
